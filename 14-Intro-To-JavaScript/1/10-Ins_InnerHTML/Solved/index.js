...
function renderHTML() {
  ...
  var paragraphMessage =
    "The 'document.querySelector' method allows us to get a reference to an element in the DOM and store it into a variable. ";
  paragraphMessage +=
    "There are a variety of properties we can set on DOM elements, one of which is called 'innerHTML'. ";
